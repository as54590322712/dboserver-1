...
void AttributeManager::LoadAttribute(sAVATAR_ATTRIBUTE* pAttribute)
{
	...
	pAvatarMaintAttribute.wBaseMaxLP = pAttribute->wBaseMaxLP;
	pAvatarMaintAttribute.wLastMaxLP = pAttribute->wLastMaxLP;
	...
	pAvatarMaintAttribute.byBaseStr = pAttribute->byBaseStr;
	pAvatarMaintAttribute.byLastStr = pAttribute->byLastStr;
	pAvatarMaintAttribute.byBaseCon = pAttribute->byBaseCon;
	pAvatarMaintAttribute.byLastCon = pAttribute->byLastCon;
	pAvatarMaintAttribute.byBaseFoc = pAttribute->byBaseFoc;
	pAvatarMaintAttribute.byLastFoc = pAttribute->byLastFoc;
	pAvatarMaintAttribute.byBaseDex = pAttribute->byBaseDex;
	pAvatarMaintAttribute.byLastDex = pAttribute->byLastDex;
	pAvatarMaintAttribute.byBaseSol = pAttribute->byBaseSol;
	pAvatarMaintAttribute.byLastSol = pAttribute->byLastSol;
	pAvatarMaintAttribute.byBaseEng = pAttribute->byBaseEng;
	pAvatarMaintAttribute.byLastEng = pAttribute->byLastEng;
...
{
	//Bases
	void* byBaseCon = &pAvatarMaintAttribute.byBaseCon;
	void* byBaseStr = &pAvatarMaintAttribute.byBaseStr;
	void* byBaseSol = &pAvatarMaintAttribute.byBaseSol;
	void* byBaseFoc = &pAvatarMaintAttribute.byBaseFoc;
	void* byBaseEng = &pAvatarMaintAttribute.byBaseEng;
	void* byBaseDex = &pAvatarMaintAttribute.byBaseDex;
	...
	void* wBaseMaxLP = &pAvatarMaintAttribute.wBaseMaxLP;
	void* wBaseMaxRP = &pAvatarMaintAttribute.wBaseMaxRP;
	//Lasts
	void* byLastCon = &pAvatarMaintAttribute.byLastCon;
	void* byLastStr = &pAvatarMaintAttribute.byLastStr;
	void* byLastSol = &pAvatarMaintAttribute.byLastSol;
	void* byLastFoc = &pAvatarMaintAttribute.byLastFoc;
	void* byLastEng = &pAvatarMaintAttribute.byLastEng;
	void* byLastDex = &pAvatarMaintAttribute.byLastDex;
	...
	void* wLastMaxLP = &pAvatarMaintAttribute.wLastMaxLP;
